#!/bin/bash
# Same as infer_hdtf_sink1_window7_redmd_taehv.sh but uses StreamingTAEHV decoder.
# Measures first_frame_latency in addition to standard timing.
#
# Usage: bash scripts/infer_hdtf_sink1_window7_redmd_taehv_streaming.sh
set -euo pipefail
...
OUT_ROOT=/home/work/output_hdtf_sink1_window7_redmd_taehv_streaming
...
echo "============================================="
echo "  ${RUN_NAME} (StreamingTAEHV): ${#ALL_CKPTS[@]} checkpoints × 4 GPUs"
echo "============================================="
