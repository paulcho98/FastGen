#!/bin/bash
# Inference for Re-DMD sink1/window7 run (training script: train_sf_sink1_window7_redmd.sh).
# Matches training knobs: local_attn_size=7, sink_size=1, use_dynamic_rope, chunk_size=3,
# 2-step schedule (t_list 0.999 0.833 0.0).
# Sweeps the last 12 checkpoints across 4 GPUs (3 per GPU), like infer_hdtf_sf_batch12.sh.
#
# Usage: bash scripts/infer_hdtf_sink1_window7_redmd.sh
set -euo pipefail
...
OUT_ROOT=/home/work/output_hdtf_sink1_window7_redmd
...
echo "============================================="
echo "  ${RUN_NAME}: ${#ALL_CKPTS[@]} checkpoints × 4 GPUs"
echo "============================================="
